...
<div class="modal-header">
	...
	<h4 class="modal-title txt-color-red">Change end date</h4>
</div>
	...
	var runFunction = function() {
		...
		$form.validate({
			...
			submitHandler: function() {
				$.post('<?= APP_URL.'/ajax/post/lease_change_end'; ?>', $form.serialize(), function(data) {
