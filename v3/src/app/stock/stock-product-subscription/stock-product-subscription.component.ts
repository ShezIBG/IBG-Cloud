...
@Component({
	selector: 'app-stock-product-subscription',
	templateUrl: './stock-product-subscription.component.html'
})
export class StockProductSubscriptionComponent implements OnInit, OnDestroy {
	...
	refresh() {
		this.api.products.listSubscriptionTypes(this.app.selectedProductOwner, response => {
	...
	editCategory(id = 'new') {
		...
		this.app.modal.open(StockProductSubscriptionCategoryModalComponent, this.moduleRef, {
