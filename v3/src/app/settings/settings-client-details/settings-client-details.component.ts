...
@Component({
	selector: 'app-settings-client-details',
	templateUrl: './settings-client-details.component.html'
})
export class SettingsClientDetailsComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		this.sub = this.route.params.subscribe(params => {
			...
			const baseRoute = '/settings/client/' + this.id;
			this.api.settings.getClient(this.id, response => {
				...
				if (this.details.module_billing) {
