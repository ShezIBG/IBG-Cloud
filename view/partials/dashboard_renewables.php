<div class="grid-stack grid-stack-responsive-height grid-height-renewable" data-gs-animate="true">
<?php
	$current_dashboard = $user->get_dashboard($db_type);
	...
	if ($widgets) {
		...
		foreach ($widgets_data as $widget_info) {
			...
			echo '
				<div class="grid-stack-item item-renewable-widget js-widget-item"
					...
					<div class="grid-stack-item-content"> <i class="eticon eticon-gear eticon-spin eticon-2x"></i> </div>
				</div>';
		}
	}
?>
