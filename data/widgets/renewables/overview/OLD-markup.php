...
//JEANE CHANGE
		...
		<div class="widget-row display-flex">
			<table class="centered txt-color-blueDark" style="font-size: 1.5em;">
				<tr>
				...
				<tr style="border-top: '.$row_spacing.' solid white;">
					<td style="padding-left: 1em;">
						<span class="eticon-stack text-center">
							...
							<i class="eticon eticon-bolt eticon-stack-1x eticon-inverse eticon-shadow"></i>
						</span>
						&nbsp;Consumed
					</td>
				...
				<tr style="border-top: '.$row_spacing.' solid white;">
					<td style="padding-left: 1em;">
						<span class="eticon-stack text-center">
							<i class="eticon eticon-circle eticon-stack-2x"></i>
							<i class="eticon eticon-bolt eticon-stack-1x eticon-shadow eticon-inverse"></i>
						</span>
						&nbsp;Imported
					</td>
					<td class="text-right" style="padding-right: 1em;">
				...
				<tr style="border-top: '.$row_spacing.' solid white;">
					<td style="padding-left: 1em;">
						<span class="eticon-stack text-center">
							...
							<i class="eticon eticon-leaf eticon-stack-1x eticon-inverse eticon-shadow"></i>
						</span>
						&nbsp;Generated
					</td>
					<td class="text-right" style="padding-right: 1em;">
			...
			$footer_content = '
				<div style="margin: 8px;">
					<table style="width: 100%;">
						<tr>
							<td>
								<p class="myBrand-colorWhite"><strong>'.$meter->info->description.'</strong></p>
								<br>
