<?php
	...
	$ui_widget->header('title', '<p class="myWidget-title">Charts</p><i class="myWidget-colorIcon eticon eticon-top-consumer eticon-top-consumer-color eticon-shadow"></i>');

	$content = '';

	$content .= '
		<div class="widget-row no-flex">
			<ul class="nav nav-tabs renew-mobile renew">
	';

	$content .= '<li class="'.($tab === 'temperature' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="temperature" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-thermometer eticon-thermometer-color"></i> Temperature</a></li>';
	$content .= '<li class="'.($tab === 'cloud' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="cloud" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-cloud eticon-cloud-color"></i> Cloud Cover</a></li>';
	if($vo) {
		$content .= '<li class="'.($tab === 'voltage' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="voltage" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-bolt eticon-bolt-color"></i> Voltage</a></li>';
		$content .= '<li class="'.($tab === 'pf' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="pf" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-bolt eticon-bolt-color"></i> Power Factor</a></li>';
		$content .= '<li class="pull-right '.($tab === 'live-pf' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="live-pf" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-bolt eticon-bolt-color"></i> Live Power Factor</a></li>';
		$content .= '<li class="pull-right '.($tab === 'live-voltage' ? 'active' : '').'"><a href="#" class="chart-widget-tab" data-tab="live-voltage" style="color: #555 !important;" data-toggle="tab"><i class="eticon eticon-bolt eticon-bolt-color"></i> Live Voltage</a></li>';
	}
		...
		if($weather_data) {
			if($tab === 'temperature') {
				...
				$yaxis = [
					...
					[ 'axisLabel' => '<span style="color:#A2B83A">Hourly Generated Power ('.$unit_html.')</span>', 'position' => 'right', 'alignTicksWithAxis' => 1, 'min' => $min_gas, 'max' => $max_gas, 'font' => [ 'color' => '#A2B83A' ] ]
				];
				...
				$xaxis = [ 'mode' => 'time', 'tickLength' => null, 'font' => [ 'color' => '#666' ] ];
				$yaxis = [
					[ 'axisLabel' => '<span style="color:#4F81A0">Cloud Cover (%)</span>', 'position' => 'left', 'min' => $min_temp, 'max' => $max_temp, 'font' => [ 'color' => '#4F81A0' ] ],
					[ 'axisLabel' => '<span style="color:#A2B83A">Hourly Generated Power ('.$unit_html.')</span>', 'position' => 'right', 'alignTicksWithAxis' => 1, 'min' => $min_gas, 'max' => $max_gas, 'font' => [ 'color' => '#A2B83A' ] ]
				];
					...
					<table style="width: 100%; height: 100%;">
						<tr>
							...
							<td style="width: 100px; padding-left: 20px;">
								<span style="background: #834225; display: inline-block; width: 20px; height: 3px; position: relative; top: -3px;"></span>&nbsp;&nbsp;&nbsp;L1<br>
								<span style="background: #000000; display: inline-block; width: 20px; height: 3px; position: relative; top: -3px;"></span>&nbsp;&nbsp;&nbsp;L2<br>
								<span style="background: #7b7b7b; display: inline-block; width: 20px; height: 3px; position: relative; top: -3px;"></span>&nbsp;&nbsp;&nbsp;L3<br>
								<span style="background: #A2B83A; display: inline-block; width: 20px; height: 3px; position: relative; top: -3px;"></span>&nbsp;&nbsp;&nbsp;Total
							</td>
						</tr>
					</table>';
