	...
	if ($building = $user->get_default_building(Permission::WATER_ENABLED)) {
						...
						<div style="display:inline-block; text-align: left;">
							...
							<p class="font-lg myBrand-colorB">
								<span class="eticon-stack text-center">
									<i class="eticon eticon-circle eticon-droplet eticon-stack-2x txt-color-blueWater"></i>
									<i class="eticon eticon-droplet eticon-droplet-color eticon-stack-1x eticon-inverse eticon-shadow"></i>
		...
		if($meter) {
			...
			$footers[] = [
				...
				'class'   => ' bg-water'  //bg-color-blueWater before
			];
		...
		if($tariff && isset($tariff->supplier_name)) {
			$footers[] = [
				...
				'class'   => 'bg-color-blueLightSky txt-color-darken'
			];
		} else {
