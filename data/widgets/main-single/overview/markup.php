<?php
	...
	$ui_widget->header('title', '<p class="myWidget-title">Your Building</strong></h2>');
	...
	if ($building = $user->get_default_building(Permission::ELECTRICITY_ENABLED)) {
		...
		<div class="myDropdown-wrapper widget-row display-flex no-flex overflow-hidden overview-building">
			<div>
		...
		<div class="widget-row display-flex no-flex overview">
			<div class="overview-detail">
				<span class="eticon-stack text-center">
					...
					<i class="eticon eticon-bolt  eticon-bolt-color eticon-inverse eticon-stack-1x eticon-shadow"></i>
				</span>
			...
			<div class="overview-detail">
				<span class="eticon-stack text-center">
					<i class="eticon eticon-circle eticon-stack-2x myBrand-Color-B"></i>
					<i class="eticon eticon-pound-sign eticon-pound-sign-color eticon-stack-1x eticon-inverse eticon-shadow"></i>
				</span>
			...
			<div class="overview-detail">
				<span class="eticon-stack text-center">
					<i class="eticon eticon-circle eticon-stack-2x myBrand-Color-B"></i>
					<i class="eticon eticon-top-consumer eticon-top-consumer-color eticon-stack-1x eticon-inverse eticon-shadow"></i>
				</span>
		...
		<div class="chart chart_second" id="kwh-usage-chart"></div>';
