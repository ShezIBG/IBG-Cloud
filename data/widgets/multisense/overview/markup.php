...
<head>
    ...
    <link rel="stylesheet" href="multichartjs.css">
...
<div class="multisense-container">
  ...
  <select name="Building" class="building" id="Building"> select building
  ...
  <button class="multi-download">Download CSV (current date)</button>
    <button class="multi-download-2">Export CSV</button>
  </div> -->
    <div class="multisense-container-elements">
        ...
        <div class="multisense-cont-info">
                ...
                <div class="fire-el">
                        <div class="fire-left-el">
                            <div class="main-fire-el"></div>
                            <div class="particle-fire-el"></div>
                        </div>
                        <div class="fire-center-el">
                            <div class="main-fire-el"></div>
                            <div class="particle-fire-el"></div>
                        </div>
                        <div class="fire-right-el">
                            <div class="main-fire-el"></div>
                            <div class="particle-fire-el"></div>
                        </div>
                        <div class="fire-bottom-el">
                            <div class="main-fire-el"></div>
                        </div>
                        </div>
