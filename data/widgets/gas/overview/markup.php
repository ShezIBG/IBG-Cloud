	...
	if ($building = $user->get_default_building(Permission::GAS_ENABLED)) {
			...
			<table class="centered">
				<tr>
					<td style="width: 33%; padding: 0 2em;">
						<svg style="max-height: 80%" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 133.92 200.51"><defs><style>.cls-1{fill:#adc8d5;stroke:#adc8d5;}.cls-1,.cls-2,.cls-3{stroke-miterlimit:10;stroke-width:3px;}.cls-2{fill:#89b5cc;stroke:#89b5cc;}.cls-3{fill:#4e81a4;stroke:#4e81a4;}</style></defs><title>gas-flame</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path class="cls-gas" d="M82.25,4.18S.61,55.47,1.51,136,82.65,203.63,107.23,185C123,173,160,123.86,96.83,73.71,82.5,62.32,62.87,42,82.25,4.18Z"/><path class="cls-gas-2" d="M76.35,71.52s-50.15,31.51-49.6,81S76.6,194,91.7,182.58c9.71-7.37,32.41-37.54-6.39-68.34C76.5,107.24,64.45,94.74,76.35,71.52Z"/><path class="cls-gas-3" d="M71.76,121.89S46.16,138,46.44,163.24s25.44,21.19,33.15,15.35c5-3.76,16.54-19.16-3.26-34.89C71.83,140.12,65.68,133.75,71.76,121.89Z"/></g></g></svg>
					</td>
						...
						<div style="display:inline-block; text-align: left;">
							...
							<p class="txt-color-blueDark font-lg">
								<span class="eticon-stack text-center">
									...
									<i class="eticon eticon-flame  eticon-flame-color eticon-stack-1x eticon-inverse eticon-shadow"></i>
								</span>&nbsp;&nbsp;&nbsp;<strong>'.App::format_number($current_total, 0, 2).' '.$unit_html.'</strong>
							</p>
							<p class="txt-color-blueDark font-lg">
								<span class="eticon-stack text-center">
									<i class="eticon eticon-arrow-'.($change < 0 ? 'down' : 'up').' eticon-stack-1x" style="font-size: 1.5em; background:transparent;"></i>
		...
		if($meter) {
					...
					<table style="width: 100%;">
						<tr>
							...
							<td class="font-xxs" style="padding-left: 1em; font-weight: bold;">
								...
								<p class="myContent-text" style="margin-bottom: 0;">
									Serial&nbsp;Number<br>
			...
			$footers[] = [
				...
				'class'   => ' first-color' // bg-color-blue before
			];
