<?php
	...
	$ui_widget->header('title', '<p class="myWidget-title">Your Climate</p> <i class="myWidget-colorIcon eticon eticon-thermometer eticon-thermometer-color  eticon-shadow"></i>');
