...
class Widget extends SmartUI {
	...
	public function print_html($return = false) {
		...
		foreach ($structure->footers as $footer) {
			...
			$new_footer_prop = parent::get_clean_structure($footer_prop, $footer, array($this), 'content');
