...
if($_SERVER['REQUEST_METHOD'] === 'GET'){
    ...
    if(!empty($start_date) && !empty($end_date) && !empty($meter_id)){
        ...
        if($bearer_token){
            ...
            if($verifyToken){
                ...
                if($meter_list){
                    ...
                    $meter_elec = CheckMeter($meter_id, 'G', $connect);
                        ...
                        if($str_date_check == true && $end_date_check == true){
                            if($meter_elec){
                                ...
                                echo json_encode(
                                    array(
                                        'status'=> '0',
                                        'Response' => "Incorrect Meter Type - Expected Gas meter only."
                                        )
                                );
